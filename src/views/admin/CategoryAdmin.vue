    ...
    <div class="data-card">
      ...
      <div class="filter-bar">
        <div class="filter-search-box">
          ...
          <input type="text" placeholder="Tìm kiếm danh mục..." class="filter-input" v-model="search"
            @input="onSearchInput" />
        </div>
        ...
        <table class="data-table">
          <thead>
            <tr>
              ...
              <th class="sortable" @click="toggleSort('name')">
                TÊN DANH MỤC <span class="sort-icon" :class="{ active: sortKey === 'name' }">{{ sortIcon('name')
                  }}</span>
              </th>
              <th>SLUG</th>
          ...
          <tbody>
            ...
            <tr v-for="cat in paginatedCategories" :key="cat.id">
              ...
              <td>
                <div class="name-cell">
                  <img v-if="cat.image" :src="imageUrl(cat.image)" :alt="cat.name" class="cat-thumb" />
      ...
      <div class="pagination">
        ...
        <div class="pagination-controls">
          ...
          <button class="page-btn nav-btn" :disabled="currentPage === totalPages" @click="goPage(currentPage + 1)">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="16" height="16">
