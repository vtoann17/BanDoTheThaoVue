...
async function submitForm() {
  ...
  loading.value = true;
  const result = await productStore.createProduct(fd);
  loading.value = false;
    ...
    <div class="page-content">
      ...
      <div class="content-header">
        <div class="content-titles">
          ...
          <p>
            Vui lòng nhập đầy đủ thông tin chi tiết cho sản phẩm mới vào kho
          </p>
        </div>
...
.breadcrumb {
  ...
  gap: 8px;
  font-size: 13px;
  margin-bottom: 8px; /* đổi từ 24px → 8px */
}
.breadcrumb-link {
  color: #6b7280;
  text-decoration: none;
...
.content-header {
  ...
  justify-content: space-between;
  align-items: center;
  margin-bottom: 16px; /* đổi từ 32px → 16px */
}
.content-titles h2 {
  font-size: 24px;
  font-weight: 700;
